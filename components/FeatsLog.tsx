...
const FeatsLog: React.FC<FeatsLogProps> = ({ feats, language }) => {
  ...
  return (
    <div className="mt-8 bg-[var(--color-card-bg)] p-6 rounded-lg border border-[var(--color-border)] backdrop-blur-md animate-fade-in-up">
      <h3 className="font-cinzel text-xl font-bold mb-4 text-[var(--color-accent)] border-b border-[var(--color-border)] pb-2">
