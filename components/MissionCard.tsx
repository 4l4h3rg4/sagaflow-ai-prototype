        ...
        <div className="text-left w-full self-start">
          ...
          <div id="tour-mission-objectives" className="bg-[var(--color-input-bg)]/20 rounded-2xl p-2 sm:p-8 ring-1 ring-white/5 mb-10 shadow-inner">
            ...
            <ul className="space-y-3 sm:space-y-5">
                ...
                <li 
                    key={index} 
                    className={`group relative rounded-xl transition-all duration-500 ease-out backdrop-blur-sm ${
                        obj.completed 
                ...
                >
                    <label className="flex items-start gap-4 sm:gap-5 cursor-pointer select-none w-full p-4 sm:p-5 min-h-[80px] items-center sm:items-start active:bg-[var(--color-input-bg)] transition-colors rounded-xl">
                        <div className="relative mt-0 sm:mt-1 shrink-0">
                            ...
                            />
                            <div className={`w-10 h-10 sm:w-6 sm:h-6 rounded-full border-2 flex items-center justify-center transition-all duration-300 ease-out ${
                                obj.completed 
                                ...
                                <svg 
                                    className={`w-6 h-6 sm:w-3.5 sm:h-3.5 text-white transition-all duration-300 cubic-bezier(0.4, 0.0, 0.2, 1) ${
                                        obj.completed ? 'opacity-100 scale-100' : 'opacity-0 scale-0 rotate-[-90deg]'
                                    }`} 
                                    fill="none" 
                                    viewBox="0 0 24 24" 
                                    stroke="currentColor" 
                        ...
                        <div className="flex-1 overflow-hidden">
                             <span 
                                ...
                                className={`text-base sm:text-lg font-medium block transition-all duration-500 ease-in-out origin-left leading-snug ${
                                    obj.completed 
